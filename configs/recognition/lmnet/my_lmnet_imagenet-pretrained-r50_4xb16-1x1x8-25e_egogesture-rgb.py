...
# 93.79
# dict(type='Resize', scale=(-1, 224)),  # 最短边缩放到224
# dict(
#     type='MultiScaleCrop',
#     input_size=224,
...
# test:
#     dict(type='CenterCrop', crop_size=(224, 224)) # 只中心裁剪(224,224)
...
test_pipeline = [
    dict(
        ...
        frame_interval=1,
        num_clips=8,
        test_mode=False,num_sample=10),# 使用test_mode=False以达到随机取样的效果，num_sample随机取样次数
    dict(type='RawFrameDecode'),
    # dict(type='Resize', scale=(224, 224), keep_ratio=False),
