...
class LAMME(nn.Module):
    def __init__(self, net, num_segments=8):
        ...
        self.lam = LAM(net.out_channels, n_segment=8)
        # self.ME = ME(k_size=3, n_segment=8)
...
class MobileNetV2LMNet(MobileNetV2):
